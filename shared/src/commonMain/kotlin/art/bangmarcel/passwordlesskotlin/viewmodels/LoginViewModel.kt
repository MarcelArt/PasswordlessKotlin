...
class LoginViewModel(private val repo: UserRepo, private val tRepo: TokenRepo, private val secureTokenManager: SecureTokenManager): ScreenModel {
    ...
    private val authState = tRepo.authState
    ...
    fun login(username: String, password: String, isRemember: Boolean, onError: (String) -> Unit, onSuccess: (LoginResponse) -> Unit) {
        ...
        screenModelScope.launch {
            try {
                ...
                tRepo.onLoginSuccess(res.items.user, res.items.accessToken, res.items.refreshToken)
